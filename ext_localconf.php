...
// ---
// KeSearch Indexer
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['ke_search']['modifyPageContentFields'][] = \Ps\Xna\KeSearchIndexer\ContentElementFields::class;
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['ke_search']['modifyContentFromContentElement'][] = \Ps\Xna\KeSearchIndexer\ContentElementFields::class;

$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['ke_search']['modifyFileIndexEntryFromContentIndexer'][] = \Ps\Xna\KeSearchIndexer\SysFileReferenceFields::class;
