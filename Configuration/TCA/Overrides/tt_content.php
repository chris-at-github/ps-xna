...
$tmpXnaTtContentColumns = [
	'tx_xna_wkhtmltopdf_enabled' => [
		'exclude' => true,
		'label' => 'LLL:EXT:xna/Resources/Private/Language/locallang_tca.xlf:tx_xna_tt_content.wkhtmltopdf_enabled',
		'config' => [
			'type' => 'check',
			'items' => [
				'1' => [
	...
	'tx_xna_wkhtmltopdf_title' => [
		'exclude' => true,
		'displayCond' => 'FIELD:tx_xna_wkhtmltopdf_enabled:>:0',
		'label' => 'LLL:EXT:xna/Resources/Private/Language/locallang_tca.xlf:tx_xna_tt_content.wkhtmltopdf_title',
		'config' => [
			'type' => 'input',
			'size' => 30,
			'eval' => 'trim,required',
